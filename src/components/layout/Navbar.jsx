      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/find-jobs" className="flex items-center space-x-3">
            ...
            <span className="text-lg font-bold text-gray-900">SideJobs</span>
          </Link>
          ...
          <div className="flex items-center space-x-3">
            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <a
                  href="/signup"
                  className="bg-blue-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-blue-700 transition-all duration-300 shadow-sm hover:shadow-md"
                >
                  Sign Up
                </a>
              </>
