          ...
          <div>
            ...
            <div className="space-y-4">
              {findWorkFeatures.map((feature, index) => (
                <div
                  key={index}
                  className="group flex items-start space-x-4 px-6 py-4 rounded-2xl hover:bg-blue-50 transition-all duration-300 cursor-pointer"
                >
          ...
          <div>
            ...
            <div className="space-y-4">
              {postWorkFeatures.map((feature, index) => (
                <div
                  key={index}
                  className="group flex items-start space-x-4 px-6 py-4 rounded-2xl hover:bg-purple-50 transition-all duration-300 cursor-pointer"
                >
